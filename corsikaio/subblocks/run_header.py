...
run_header_fields_65 = [
    ...
    Field(6, 'observation_height', length=10),
    ...
    Field(25, 'physical_constants_and_interaction_flags', length=50),
    Field(94 + 1, 'cka', length=40),
    Field(134 + 1, 'ceta', length=5),
    Field(139 + 1, 'cstrba', length=11),
    Field(254 + 1, 'aatm', length=5),
    Field(259 + 1, 'batm', length=5),
    Field(264 + 1, 'catm', length=5),
    Field(270, 'nflain'),
    Field(271, 'nfdif'),
    Field(272, 'nflpi0_100nflpif'),
    Field(273, 'nflche_100nfgragm'),
]
...
run_header_fields_7x = [
    ...
    Field(4, 'version'),
    Field(5, 'n_observation_levels'),
    Field(5 + 1, 'observation_height', length=10),
    Field(16, 'energy_spectrum_slope'),
    Field(17, 'energy_min'),
    Field(18, 'energy_max'),
    Field(19, 'egs4_flag'),
    ...
    Field(23, 'energy_cutoff_electrons'),
    Field(24, 'energy_cutoff_photons'),
    Field(24 + 1, 'physical_constants_and_interaction_flags', length=50),
